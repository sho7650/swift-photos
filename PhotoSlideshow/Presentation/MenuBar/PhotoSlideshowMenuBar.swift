...
/// SwiftUI Commands integration for PhotoSlideshow menu bar
/// Provides declarative menu bar configuration with recent files support
public struct PhotoSlideshowMenuBar: Commands {
    ...
    private func showErrorAlert(_ message: String) {
        DispatchQueue.main.async {
            let alert = NSAlert()
            alert.messageText = "PhotoSlideshow"
...
extension PhotoSlideshowMenuBar {
    /// Create a PhotoSlideshowMenuBar with automatic integration
    /// This is the recommended way to integrate the menu bar with your SwiftUI app
    public static func integrated(
        recentFilesManager: RecentFilesManager,
        onFolderSelected: @escaping (URL) -> Void
    ) -> PhotoSlideshowMenuBar {
        return PhotoSlideshowMenuBar(
            recentFilesManager: recentFilesManager,
